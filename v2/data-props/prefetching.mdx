...
<a href="/users" prefetch cache-for="1m">Users</a>
<a href="/users" prefetch cache-for="10s">Users</a>
<a href="/users" prefetch :cache-for="5000">Users</a>
```

```jsx React icon="react"
import { Link } from '@inertiajs/react'

<a href="/users" prefetch cacheFor="1m">Users</a>
<a href="/users" prefetch cacheFor="10s">Users</a>
<a href="/users" prefetch cacheFor={5000}>Users</a>
```
...
<a href="/users" prefetch="click">Users</a>
```
...
<a href="/users" prefetch="mount">Users</a>
```
...
<a href="/users" :prefetch="['mount', 'hover']">Users</a>
```
...
<template>
  <a href="/users" prefetch cache-tags="users">Users</a>
  <a href="/dashboard" prefetch :cache-tags="['dashboard', 'stats']">Dashboard</a>
</template>
```
...
<a href="/users" prefetch cacheTags="users">Users</a>
<a href="/dashboard" prefetch cacheTags={['dashboard', 'stats']}>Dashboard</a>
```
...
<a href="/users" prefetch :cacheFor="['30s', '1m']">Users</a>
```
