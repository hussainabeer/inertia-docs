...
<ParamField body="mergeProps" type="array">
  Array of prop keys that should be merged (appended) during navigation. See the [merging props](/v2/data-props/merging-props) documentation for details.
</ParamField>
...
<ParamField body="deferredProps" type="object">
  Configuration for client-side lazy loading of props. See the [deferred props](/v2/data-props/deferred-props) documentation for details.
</ParamField>
